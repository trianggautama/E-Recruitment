...
<body>
    ...
    <div class="container">
        <div class="isi">
        <hr>
            <h3 style="text-align:center; text-transform:uppercase;">DATA HASIL UJI KOMPETENSI {{$uji_wawancara->lowongan->berita->judul}} dengan status @if($status == 1 ) Lulus @else Tidak Lulus @endif</h3>
            <br>
