...
<body>
    <div class="header">
        ...
        <div class="headtext">
            ...
            <p style="margin:0px;">Karang Mekar, Kec. Banjarmasin Tim., Kota Banjarmasin, Kalimantan Selatan 70236,
                Telepon :(0511) 3255551</p>
        </div>
        <br>
    </div>
    <div class="container">
        <div class="isi">
            <hr>
            <h2 style="text-align:center; text-transform:uppercase;">DATA ANALISIS PELAMAR {{$lowongan->berita->judul}}
            </h2>
            <br>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>: {{carbon\carbon::parse($lowongan->tgl_mulai)->translatedFormat('d F Y')}} -
                        {{carbon\carbon::parse($lowongan->tgl_selesai)->translatedFormat('d F Y')}}</td>
                </tr>
                <tr>
