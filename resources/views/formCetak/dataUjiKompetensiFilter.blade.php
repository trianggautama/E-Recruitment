...
<body>
    ...
    <div class="container">
        <div class="isi">
        <hr>
            <h3 style="text-align:center; text-transform:uppercase;">DATA HASIL UJI KOMPETENSI {{$uji_kompetensi->lowongan->berita->judul}} DENGAN STATUS @if($status == 1) LULUS @else TIDAK LULUS @endif</h3>
            <br>
